      ...
      {hasBooks ? (
        <section className="map" style={{ paddingBottom: 0 }}>
          <div className="section-head">
            ...
            <p>
              칸의 숫자는 그 권에서 <b>단원에 이어진 장 수 / 전체 장 수</b>입니다. 눌러 보면 그 권이
              처음 이어 준 단원으로 갑니다.
            </p>
          </div>
        ...
        <section>
          ...
          <div className="detail-grid">
            <div className="detail-block">
              <h3>장 이름은 긁은 그대로입니다</h3>
              <p>
                서점·출판사 공개 페이지에서 가져온 장 이름을 한 글자도 고치지 않습니다. 다만 세지
                않는 것이 셋 있습니다. 장 아래를 다시 쪼갠 소단원(①②③), 목차 뒤에 붙는
                모의고사·정답 색인, 그리고 서점이 다른 학년 목차를 실어 둔 권입니다. 각 권의 출처
                링크로 직접 확인하세요. 판(년도)이 바뀌면 목차도 바뀝니다.
              </p>
            </div>
            <div className="detail-block">
            ...
            <div className="detail-block">
              <h3>억지로 잇지 않았습니다</h3>
              <p>
                교재의 장 이름이 지도의 단원 이름과 맞을 때 잇습니다. 장 이름이 단원 이름 그대로면
                그 장 하나가 그 단원이고, 그런 장이 여럿이면 가장 정확한 하나가 자리를 갖습니다.
                장 이름이 단원 이름의 <b>일부</b>일 때는(&ldquo;순열&rdquo;, &ldquo;조합&rdquo;)
                여러 장이 함께 붙습니다. 이름으로 못 이은 장은 그 단원에 적어 둔 핵심어, 다음으로
                교재의 대단원 이름과 견줍니다. 고등은 지도의 단원 하나가 교재의 대단원 하나여서 이
                단계가 필요합니다. 다 아니면 잇지 않고 비워 둡니다. 위의 &ldquo;{"n/m"}장&rdquo;
                표기가 그 비율입니다.
              </p>
            </div>
          </div>
