        ...
        <section>
          ...
          <div className="detail-grid">
            <div className="detail-block">
              ...
              <p>
                서점·출판사 공개 페이지에서 가져온 장 이름을 한 글자도 고치지 않습니다. 다만 목차
                뒤에 붙는 모의고사·정답 색인은 같은 목록의 되풀이라 세지 않고, 서점이 다른 학년
                목차를 실어 둔 권은 아예 뺍니다. 각 권의 출처 링크로 직접 확인하세요. 판(년도)이
                바뀌면 목차도 바뀝니다.
              </p>
            </div>
            <div className="detail-block">
            ...
            <div className="detail-block">
              <h3>억지로 잇지 않았습니다</h3>
              <p>
                교재의 장 이름이 지도의 단원 이름과 맞을 때 잇습니다. 한 단원을 여러 장이 가리키면
                이름이 가장 정확한 장이 그 자리를 갖습니다. 이름으로 못 이은 장은 그 단원에 적어 둔
